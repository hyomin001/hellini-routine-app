...
UPDATE_LOG = [
    {
        "date": "2026-08-22",
        "items": [
            "🏅 헬린이 등급제 추가: 총 기록일(누적 운동일수)에 따라 시작 전(흰색)부터 새싹·성장중·숙련자·베테랑·마스터·레전드(1년+)까지 7단계 등급 (마이페이지에서 확인)",
            "🎯 '오늘 뭐 할지 정하기' 추가: 운동 직접 골라서 오늘의 루틴만 보기 / 부위 고르면 무작위 추천 + 방법 설명",
            "⏱ 휴식 타이머를 각 운동의 '세트 기록' 칸 바로 위로 이동 (스크롤 안 해도 바로 눌러요)",
            "🔄 대체 운동 기능 추가: 기구 자리가 없을 때 같은 부위 다른 운동으로 바꿔서 바로 기록 가능",
        ],
    },
    {
        "date": "2026-08-21",
