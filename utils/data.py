...
UPDATE_LOG = [
    {
        "date": "2026-08-27",
        "items": [
            "🎯 '오늘 뭐 할지 정하기'에 목표 기반 추천 추가: 전신(~60분)·상체만(~40분)·하체만(~30분) 버튼 하나로 부위·종목 수까지 한 번에 추천",
            "🧩 나만의 루틴 만들기의 '초보자 자동 추천'을 위 추천 로직과 통일해서, 두 화면에서 서로 다른 방식으로 추천되던 것을 정리",
            "부위를 여러 개 골라 한 번에 추천할 때 같은 운동이 두 부위에 걸쳐 중복으로 뽑히던 문제 수정",
            "웜업 중 운동 1개만 빠르게 추천받는 기존 기능은 그대로 유지 (이름만 '웜업 중 딱 1개만'으로 명확화)",
        ],
    },
    {
        "date": "2026-08-24",
